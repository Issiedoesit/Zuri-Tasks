...
while True:
    ...
    def find_anagram(word_entry, anagram):
        ...
        if word_one_sort == word_two_sort:
            print('True') 
            print(' ')
            print('After cleaning: \" {} \" and \" {} \" are anagrams'.format(word_entry, anagram))
            print('Clean-up on entry returned: Word [{}] and Anagram[{}]'.format(word_one_joined, word_two_joined))
        else:
            print ('False')
            print(' ')
            print('After cleaning: \" {} \" and \" {} \" are not anagrams'.format(word_entry, anagram))
            print('Clean-up on entry returned: Word [{}] and Anagram[{}]'.format(word_one_joined, word_two_joined))
        print(' ')
